...
export class CardComponent implements OnInit {
  @Input() card: Card = { title: 'Default', text: 'text is default' };
  @Input() i?: number;
  ...
  ngOnInit(): void {
    setTimeout(() => {
      this.imgUrl =
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGeQOAHMokvnQ5oqd4FHrOhSDrLuvFELPrtsK2iPIhv7DGh342L6N9srwLQ9eELatdFwQ&usqp=CAU';
      this.disabled = true;
    }, 2000);
  }
